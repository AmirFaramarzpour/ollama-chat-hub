...
if __name__ == "__main__":
    ...
    chat_history_label = ctk.CTkLabel(main_frame, text="Ollama Live Chat 📜", font=("Trebuchet MS", 16), text_color="white", corner_radius=8, fg_color="#158542")
    ...
    prompt_entry_label = ctk.CTkLabel(main_frame, text="Your Prompts 💭", font=("Trebuchet MS", 16), text_color="white", corner_radius=8, fg_color="#158542")
